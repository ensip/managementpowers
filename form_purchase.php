...
<section class="section-flexible section-html section-products">
	...
	<form style="" action="purchase.php" method="POST">
		...
		<label class="required" for="reference">Reference product*</label>
		<input type="" name="reference">
		<input type="submit" class="submit" style="display: inline-block; text-transform: uppercase; font-family: 'Qanelas Soft Bold',Helvetica,Arial,serif; font-size: 0.9rem; letter-spacing: .15rem; line-height: 1.3rem; font-weight: bold; padding-left: 40px; padding-right: 40px;" value="Continue" name="purchase">
	</form>
	</section>
